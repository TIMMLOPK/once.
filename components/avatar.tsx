  ...
  return (
    <div
      className={cn(
        ...
        "from-white/80 to-white/40 after:absolute after:inset-0 after:-z-10 after:rounded-full after:bg-gradient-to-br after:bg-clip-content after:p-px dark:after:from-black/60 dark:after:to-black",
