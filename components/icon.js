...
const Icon = ({ src }) => {
  const before = `before:absolute before:z-[-1] before:animate-rotate before:w-[200%] before:h-[200%] before:content-[''] before:bg-[conic-gradient(#00000080,#00000040,#00000030,#00000020,#00000010,#00000010,#00000080)] dark:before:bg-[conic-gradient(#ffffff80,#ffffff40,#ffffff30,#ffffff20,#ffffff10,#ffffff10,#ffffff80)]`;
  const after =
