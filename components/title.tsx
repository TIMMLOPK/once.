  ...
  return (
    <div
      className={cn(
        ...
        "after:absolute after:inset-0 after:z-10 after:box-border after:rounded-full after:border-4 after:border-transparent after:bg-white after:bg-clip-content after:dark:bg-[#121212] after:lg:border-4",
