    ...
    <div className="flex items-center p-4">
      <span className="mr-4 flex h-10 w-10 items-center justify-center">
        <Image
          ...
          width={35}
          height={35}
          className="rounded-full shadow-small"
        />
      </span>
...
const Shop = () => {
  return (
    <main className="m-auto max-w-4xl p-6 md:px-20">
      <section className="py-8 md:flex md:space-x-10">
        <Icon src="/shop/icon.webp" />
        <div>
          <h1 className="my-8 font-serif text-4xl">@murasaki_jpstore</h1>
      ...
      <section className="py-14">
        ...
        <div className="max-w-10 space-y-4 dark:text-zinc-300">
          <p>
            (商品日元價格連稅＋日本國内運費(如有))*(本店匯率)+(手續費)+(國際運費)
          </p>
          <p>本月匯率=0.067-0.075(視乎商品日元價格，每月匯率調整)</p>
          <div>
          ...
          <div className="space-y-2 dark:text-zinc-300">
            <p>
      ...
      <section className="my-5 grid grid-cols-1 gap-2">
        <Title>付款方式</Title>
      ...
      <section className="py-14">
        <Title>運送時效</Title>
        <div className="text-md space-y-4 dark:text-zinc-300">
      ...
      <section className="inline-flex items-center justify-center">
        <div className="flex h-16 w-16 flex-col space-y-4">
          <Image
            src="/shop/icon.webp"
