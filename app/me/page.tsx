          ...
          <div className="lg:order-first lg:row-span-2">
            <div className="text-base leading-relaxed text-zinc-600 dark:text-zinc-100">
              ...
              <p>
                ...
                passionate about building things that make people’s lives
                better. I am also a fan of open source and love to contribute to
                the community.
              </p>
              <br />
              <p>
                I created some works that I am proud of. If you are interested,
                ...
                . If you have any questions or want to chat, feel free to reach
                out to me by way of the socials below.
              </p>
              <br />
              <p className="z-10">
                The world is{" "}
                ...
                and ever-changing. I believe that the only way to keep up with
                the world is to keep learning. I am always learning and trying
                to improve myself. I am also a big fan of the idea of learning
                in public. I love to share my knowledge and experience with
